...
module.exports = {
    ...
    execute(message, args) {
        ...
        const warn1Role = message.guild.roles.cache.find(r => r.name === "RP Uyarı-1");
        const warn2Role = message.guild.roles.cache.find(r => r.name === "RP Uyarı-2");
        const warn3Role = message.guild.roles.cache.find(r => r.name === "RP Uyarı-3");
...
if (warnCount === 0) {
    ...
    message.channel.send(`${member} uyarıldı! (1. rp uyarı)`);
} else if (warnCount === 1) {
    ...
    message.channel.send(`${member} ikinci kez uyarıldı! (2. rp uyarı)`);
} else if (warnCount === 2) {
    ...
    message.channel.send(`${member} üçüncü kez uyarıldı! (3. rp uyarı)`);
} else {
